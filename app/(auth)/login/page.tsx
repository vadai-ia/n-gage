    ...
    <div className="min-h-screen flex items-center justify-center px-5" style={{ background: "#07070F" }}>
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="flex flex-col items-center mb-10">
          <svg width={56} height={56} viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg" className="mb-3">
            <defs>
              <linearGradient id="fl" x1="128" y1="64" x2="384" y2="448" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="#FF2D78"/><stop offset="50%" stopColor="#7B2FBE"/><stop offset="100%" stopColor="#1A6EFF"/>
              </linearGradient>
            </defs>
            <path d="M256 480C256 480 64 320 64 200C64 120 128 64 200 64C230 64 256 80 256 80C256 80 248 48 280 24C312 48 304 80 304 80C350 50 400 80 430 120C460 160 448 220 448 220C448 320 256 480 256 480Z" fill="url(#fl)"/>
          ...
          <h1 className="text-4xl font-black tracking-tight mb-1.5"
            style={{ background: "linear-gradient(135deg, #FF2D78, #7B2FBE)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
            N&apos;GAGE
          </h1>
